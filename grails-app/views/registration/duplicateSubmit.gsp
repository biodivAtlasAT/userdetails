...
<div class="row">
    ...
    <div class="row">
        ...
        <ul class="userdetails-menu">
            ...
            <li>
                <g:message code="duplicate.submit.next.rerun1" /> <g:link controller="registration" action="forgottenPassword"><g:message code="duplicate.submit.next.rerun2" /></g:link>.
            </li>
            <li>
